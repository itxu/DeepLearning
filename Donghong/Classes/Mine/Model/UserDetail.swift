...
//  Donghong
//
//  Created by Donghong on 2019/3/26.
...
struct UserDetail: HandyJSON {
    ...
    var media_id: Int = 0
    var ugc_public_media_id: Int = 0
    var user_id: Int = 0
    var creator_id: Int = 0
    
    var description: NSString = ""
    var descriptionHeight: CGFloat? {
        return description.boundingRect(with: CGSize(width: kWidth - 30.0, height: CGFloat(MAXFLOAT)), options: .usesLineFragmentOrigin, attributes: [.font: UIFont.systemFont(ofSize: 13)], context: nil).size.height + 5.0
    }
...
//        return Calculate.textHeight(text: content, fontSize: 17, width: kWidth - 30.0)
//    }
//
//    var contentH: CGFloat {
//        let height = Calculate.textHeight(text: content, fontSize: 17, width: kWidth - 30.0)
//        return height >= 110 ? 110 : height
//    }
//
//    /// 富文本内容高度
//    var attributedCntentHeight: CGFloat {
//        let height = Calculate.attributedTextHeight(text: attributedContent, width: kWidth - 30.0)
...
//
    /// collectionView 宽度
//    var collectionViewW: CGFloat {
//        return isDongtaiDetail ? (kWidth - 30) : Calculate.collectionViewWidth(thumb_image_list.count)
//    }
    var ugc_cut_image_list = [UGCCutImage]()
...
struct UserDetailQuestion: HandyJSON {
    ...
    var title: String = ""
//    var titleH: CGFloat {
//        return Calculate.textHeight(text: title, fontSize: 17, width: kWidth - 30.0) + 5
//    }
...
//        let height = Calculate.textHeight(text: text, fontSize: 16, width: kWidth - 30.0)
